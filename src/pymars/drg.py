...
def reduce_drg(model_file, species_targets, species_safe, threshold, 
               matrices, ignition_conditions, psr_conditions, plflame_conditions, sampled_metrics_idt, sampled_metrics_psr, 
               sampled_metrics_plflame, phase_name='', previous_model=None, threshold_upper=None, 
               num_threads=1, path=''
               ):
    ...
    #print('species_safe:     ', species_safe)
    ...
    #print('species_removed:      ', species_removed)
...
def run_drg(model_file, ignition_conditions, psr_conditions, plflame_conditions, 
    ...
    # ===================================================================================
    # ======================================== INCLUDE PSR_CONDITIONS


    #print('plflame_cond:    ', plflame_conditions)
    ...
    #print('sampled metrcs:      ', sampled_metrics_plflame)
    ...
    while error_current_idt <= error_limit and error_current_psr<= error_limit  and error_current_plflame<= error_limit:
        reduced_model = reduce_drg(
            ...
            sampled_metrics_plflame, phase_name=phase_name, previous_model=previous_model, 
    ...
    if error_current_idt > error_limit or error_current_psr > error_limit or error_current_plflame > error_limit:
            threshold -= (2 * threshold_increment)
            reduced_model = reduce_drg(
                model_file, species_targets, species_safe, threshold, matrices, 
                ignition_conditions, psr_conditions, plflame_conditions, sampled_metrics_idt, sampled_metrics_psr,
                sampled_metrics_plflame, phase_name=phase_name, threshold_upper=threshold_upper, num_threads=num_threads, 
                path=path)
